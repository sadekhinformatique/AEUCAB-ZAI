...
const SAMPLES: Record<string, string> = {
  members: "firstName,lastName,sex,phone,email,faculty,department,level,academicYear\nJean,Dupont,M,0600000001,jean@example.com,Sciences,Informatique,L1,2024-2025\nMarie,Curie,F,0600000002,marie@example.com,Sciences,Physique,L2,2024-2025",
    ...
    try {
      ...
      if (type === "members") {
        ...
        rows = (data || []).map((m: any) => ({
          ...
          telephone: m.phone, email: m.email, faculte: m.faculty, filiere: m.department,
