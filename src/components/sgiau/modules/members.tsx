...
import { MEMBER_STATUS_COLORS, MEMBER_STATUS_LABELS } from "@/lib/sgiau/constants"
...
const FACULTIES = ["Sciences", "Droit", "Économie", "Lettres", "Médecine", "Ingénierie"]
...
export default function MembersModule() {
  ...
  function exportCSV() {
    const rows = members.map((m) => ({
      ...
      faculte: m.faculty, filiere: m.department, niveau: m.level, annee: m.academicYear,
    ...
    reader.onload = async () => {
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        const payload = {
          ...
          email: row.email || "",
          faculty: row.faculte || row.faculty || "",
          department: row.filiere || row.department || "",
      ...
      <SectionCard>
        <div className="flex flex-col sm:flex-row gap-2 mb-4">
          ...
          <Select value={faculty} onValueChange={setFaculty}>
            <SelectTrigger className="w-full sm:w-48"><SelectValue placeholder="Faculté" /></SelectTrigger>
            <SelectContent>
            ...
            <Table>
              <TableHeader className="sticky top-0 bg-card z-10">
                <TableRow>
                  ...
                  <TableHead className="hidden md:table-cell">Faculté / Niveau</TableHead>
      ...
      <Dialog open={formOpen} onOpenChange={setFormOpen}>
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto scroll-thin">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-2">
            ...
            <Field label="Filière"><Input value={form.department} onChange={(e) => setForm({ ...form, department: e.target.value })} /></Field>
            <Field label="Niveau">
            ...
            <>
              ...
              <div className="px-4 pb-6 space-y-4 mt-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <Info label="Faculté" value={detail.faculty ?? "—"} />
                  <Info label="Filière" value={detail.department ?? "—"} />
