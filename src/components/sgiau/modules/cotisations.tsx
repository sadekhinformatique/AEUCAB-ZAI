...
import { COTISATION_KIND_LABELS, PAYMENT_MODE_LABELS, PAYMENT_STATUS_LABELS } from "@/lib/sgiau/constants"
      ...
      <Dialog open={typeFormOpen} onOpenChange={setTypeFormOpen}>
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-2">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-medium">Faculté (option)</Label>
